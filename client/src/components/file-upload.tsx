      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-base max-w-xl mx-auto">
            Pick your printer setup, choose Color or Black &amp; White, then
            page size and resolution. Upload to get accurate cartridge coverage
            and per-page cost.
          </p>
        </div>
        ...
        <div
          ...
          style={{
            boxShadow:
              "0 4px 20px rgba(0,0,0,0.07), 0 16px 40px rgba(0,0,0,0.06)",
          }}
        >
          {/* Step 1: Printer Type */}
          <div>
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">
              Step 1 — Printer / Cartridge Type
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <Droplets
                  className={`w-5 h-5 mt-0.5 ${printerType === "cmyk" ? "text-green-700" : "text-gray-400"}`}
                />
                <div>
                  <div
                    className={`font-semibold text-sm ${printerType === "cmyk" ? "text-green-900" : "text-gray-700"}`}
                  >
                    CMYK Cartridge Analysis
                  </div>
              ...
              >
                <Printer
                  className={`w-5 h-5 mt-0.5 ${printerType === "color-black" ? "text-green-700" : "text-gray-400"}`}
                />
                <div>
                  <div
                    className={`font-semibold text-sm ${printerType === "color-black" ? "text-green-900" : "text-gray-700"}`}
                  >
                    Color &amp; Black (Inkjet)
                  </div>
                  <div className="text-xs text-gray-500 mt-0.5">
                    Standard 2-cartridge inkjet. Shows combined Color cartridge
                    usage and Black cartridge usage.
                  </div>
                </div>
              </button>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <Layers
                  className={`w-5 h-5 ${colorMode === "color" ? "text-green-700" : "text-gray-400"}`}
                />
                <div>
                  <div
                    className={`font-semibold text-sm ${colorMode === "color" ? "text-green-900" : "text-gray-700"}`}
                  >
                    Color Print
                  </div>
                  <div className="text-xs text-gray-500 mt-0.5">
              ...
              >
                <Printer
                  className={`w-5 h-5 ${colorMode === "bw" ? "text-green-700" : "text-gray-400"}`}
                />
                <div>
                  <div
                    className={`font-semibold text-sm ${colorMode === "bw" ? "text-green-900" : "text-gray-700"}`}
                  >
                    Black &amp; White Print
                  </div>
                  <div className="text-xs text-gray-500 mt-0.5">
          ...
          <div>
            ...
            <Label className="text-xs text-gray-500 mb-2 mt-4 block">
              Resolution (DPI)
            </Label>
          ...
          <div>
            ...
            <div
              className={`rounded-xl border-2 p-4 transition-colors ${termsAccepted ? "border-green-300 bg-green-50" : "border-amber-200 bg-amber-50"}`}
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                    ...
                    . Your document is processed for coverage analysis only and
                    is not retained.
                  </p>
              ...
              >
                ...
                >
                  <Upload
                    ...
                    style={termsAccepted ? { color: "hsl(133, 48%, 36%)" } : {}}
                  />
                </div>
                <p
                  className={`text-base font-semibold mb-1 ${termsAccepted ? "text-gray-800" : "text-gray-400"}`}
                >
                  {!termsAccepted
              ...
              style={{
                ...
                boxShadow:
                  uploadedFile && !analyzeMutation.isPending
                    ? "0 4px 20px rgba(46,160,80,0.35)"
                    : "none",
              }}
            >
